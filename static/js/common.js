commonObj = {
    ...
    getData: function (pagenumber) {
        $.ajax({
            type: "get",
            url: "/wx_store/static/js/test.json",
            data: {
    ...
    scrollHandler: function () {
       ...
       if (parseInt(scrollT) + parseInt(winH) + 50 >= parseInt(pageH) && commonObj.ajaxstatus) {
    ...
    addAnimate:function(e){
        ...
        var productimg=$("#productimg"),
           imgsrc=$("#productimg").children("img").attr("src"),
            ...
            var $obj=$('#flydiv');
            if(!$obj.is(':animated')){
                $obj.css({'left': x,'top': y}).animate({'left': X+8,'top': Y-80},500,function() {
